...
target "_pkg-containerd" {
  args = {
    ...
    PKG_REF = PKG_REF != null && PKG_REF != "" ? PKG_REF : "main"
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.27.1" # https://github.com/containerd/containerd/blob/main/.github/workflows/release/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
    PKG_DEB_EPOCH = PKG_DEB_EPOCH != null && PKG_DEB_EPOCH != "" ? PKG_DEB_EPOCH : ""
...
target "_pkg-cagent" {
  args = {
    ...
    PKG_REF = PKG_REF != null && PKG_REF != "" ? PKG_REF : "main"
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.27.0" # https://github.com/docker/cagent/blob/main/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
    PKG_DEB_EPOCH = PKG_DEB_EPOCH != null && PKG_DEB_EPOCH != "" ? PKG_DEB_EPOCH : ""
    PKG_REMOTE_DOCKERFILE = "Dockerfile"
  }
